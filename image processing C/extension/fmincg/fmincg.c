...
int fmincg(void(*costFunc)(COST_FUNC_DATATYPE* inputVector, COST_FUNC_DATATYPE* cost, COST_FUNC_DATATYPE* gradVector, matrix_t *dataM, matrix_t *labelsM), COST_FUNC_DATATYPE* xVector, int ndim, int maxCostCalls, matrix_t *data, matrix_t *labels)
{
	...
	(*costFunc)(xVector, &f1, df1, data, labels);
